 ...
 */
package UI.popUps.Ventas.Borrar;
 ...
 * @author momo
 */
public class frameBorrarVenta extends javax.swing.JFrame {

    /**
     * Creates new form testFrame
     */
    public frameBorrarVenta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitulo.setText("Eliminar Venta:");
    ...
    private void btnConfirmarModificacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarModificacionActionPerformed
        String ID_venta = txtNumeroSerie.getText();        
        try {
            int intID = Integer.parseInt(ID_venta);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frameBorrarVenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frameBorrarVenta().setVisible(true);
            }
        });
    }
